...
async def inline_help_func(__HELP__):
    ...
    answerss = [
        ...
        InlineQueryResultArticle(
            ...
            input_message_content=InputTextMessageContent(
                "https://github.com/GhangaleSangram/MY_TelegramBot"
            ),
            thumb_url="https://telegra.ph/file/7986ca83ad9dd77116509.png",
        ),
    ]
...
async def alive_function(answers):
    ...
    msg = f"""
**[SangramGhangale✨](https://github.com/GhangaleSangram/MY_TelegramBot):**
**MainBot:** `{bot_state}`
**UserBot:** `{ubot_state}`
...
"""
    answers.append(
        InlineQueryResultArticle(
            ...
            thumb_url="https://telegra.ph/file/be355cf0d1a7e7008a7b9.jpg",
            input_message_content=InputTextMessageContent(
...
async def music_inline_func(answers, query):
    chat_id = -1001267448966
    group_invite = "https://t.me/Friends_Group_Chatting"
    try:
        messages = [
            m
